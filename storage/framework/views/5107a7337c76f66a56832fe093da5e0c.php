...
<section id="video-section-container" 
         ...
         x-data="{
             videos: <?php echo e(json_encode($videos)); ?>,
             activeVideo: <?php echo e(json_encode($featuredVideo)); ?>,
             modalOpen: false,
             selectVideo(vid) {
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
            ...
            <div>
                <a href="<?php echo e(route('guest.news.index')); ?>#videos-section"
...
<?php /**PATH /var/www/resources/views/components/home/videos-reels.blade.php ENDPATH**/ ?>