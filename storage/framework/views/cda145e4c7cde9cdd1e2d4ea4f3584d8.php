<div x-data="{
        ...
        selectedIndex: 0,
        items: [
            { title: 'Educational Assistance (Scholarship)', category: 'Scholarship', url: '<?php echo e(route('services.educational-assistance')); ?>', icon: 'academic-cap' },
            { title: 'Frequently Asked Questions (FAQ)', category: 'Help Desk', url: '<?php echo e(route('faq')); ?>', icon: 'question-mark' },
            { title: 'Citizen\'s Charter', category: 'Transparency', url: '<?php echo e(route('citizens-charter')); ?>', icon: 'document' },
            { title: 'Bids & Awards Committee (BAC)', category: 'Procurement', url: '<?php echo e(route('bac')); ?>', icon: 'badge' },
            { title: 'Transparency Seal', category: 'Governance', url: '<?php echo e(route('seal')); ?>', icon: 'shield' },
            { title: 'Visit CamSur - Tourism & Eco-Adventure', category: 'Tourism', url: '<?php echo e(route('tourism')); ?>', icon: 'globe' },
            { title: 'Provincial Socio-Economic Profile', category: 'About', url: '<?php echo e(route('socio-economic')); ?>', icon: 'chart' },
            { title: 'Government Careers & Plantilla', category: 'Careers', url: '<?php echo e(route('careers.government')); ?>', icon: 'briefcase' },
            { title: 'Private Local Job Directory (PESO)', category: 'Careers', url: '<?php echo e(route('careers.local')); ?>', icon: 'briefcase' },
            { title: 'Overseas & OFW Opportunities', category: 'Careers', url: '<?php echo e(route('careers.overseas')); ?>', icon: 'briefcase' },
            { title: 'SPES & Student Internships', category: 'Careers', url: '<?php echo e(route('careers.spes')); ?>', icon: 'briefcase' },
            { title: 'History of Camarines Sur', category: 'About', url: '<?php echo e(route('province-history')); ?>', icon: 'book' },
            { title: 'Mission & Vision', category: 'About', url: '<?php echo e(route('mission-vision')); ?>', icon: 'lightbulb' },
            { title: 'Past Governors of Camarines Sur', category: 'About', url: '<?php echo e(route('past-governors')); ?>', icon: 'user-group' },
            { title: 'Press Releases & Advisories', category: 'News', url: '<?php echo e(route('press-releases.index')); ?>', icon: 'newspaper' },
            { title: 'Latest Capitol News', category: 'News', url: '<?php echo e(route('guest.news.index')); ?>', icon: 'newspaper' }
        ],
        ...
        <div @click.away="closeModal()"
            ...
            <ul class="max-h-80 scroll-py-2 divide-y divide-gray-50 overflow-y-auto p-2 text-sm text-gray-800">
                ...
                <li x-show="filteredItems.length === 0" class="py-8 text-center text-gray-500">
                    ...
                    <a :href="'<?php echo e(route('search')); ?>?q=' + encodeURIComponent(query)" class="mt-2 inline-block text-xs font-bold text-blue-700 hover:underline">
            ...
            <div class="bg-gray-50 px-4 py-2.5 flex items-center justify-between text-xs text-gray-500">
                ...
                <a :href="'<?php echo e(route('search')); ?>?q=' + encodeURIComponent(query)" class="font-bold text-blue-800 hover:underline">
...
<?php /**PATH /var/www/resources/views/components/guest/panels/search-modal.blade.php ENDPATH**/ ?>