<div x-data="{
    ...
    {{-- 🎛️ Unified Pill Dock (Accessibility on Left, Scroll to Top on Right) --}}
    <div class="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-slate-900/90 backdrop-blur-md border border-slate-700/80 shadow-2xl rounded-full p-1.5 transition-all duration-300 hover:shadow-blue-950/40 hover:border-slate-600">
        ...
        {{-- ♿ Accessibility Trigger Button with Tooltip --}}
        <div class="relative group flex items-center justify-center">
            <button type="button"
                ...
                {{-- Universal Accessibility Human Figure (Vitruvian / Open Arms & Legs) --}}
        ...
        {{-- 🚀 Auto Scroll Up Button with Tooltip --}}
    ...
    {{-- Accessibility Options Modal / Flyout --}}
    <div x-show="isOpen"
