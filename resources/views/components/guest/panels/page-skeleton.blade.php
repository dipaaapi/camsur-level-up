...
{{-- Universal Page Skeleton Loader (Dynamic Structure Matched per Page Type) --}}
<div 
...
>
    ...
    @elseif($isHistory)
        {{-- PROVINCE & CAPITOL HISTORY EXACT MATCHED SKELETON --}}
        {{-- 1. Hero Banner --}}
        ...
        {{-- 3. Exact Matched Overview Section --}}
        <div class="flex-1 overflow-hidden px-4 py-12 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-7xl space-y-8">
                {{-- Dark Hero Overview Card matching overview.blade.php --}}
                ...
                {{-- Map (7 cols) + Province at a Glance (5 cols) --}}
    ...
    @else
        {{-- DEFAULT / PROFILE / MISSION SKELETON --}}
...
{{-- Global Skeleton Shimmer CSS & Load Detection Script --}}
<style>
